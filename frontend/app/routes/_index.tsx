...
const Wave = () => {
  ...
  const waveLoop = useCallback(() => {
    ...
    const height = 267 * Math.sin(elapsed * Math.PI);
    element.current.style.height = `${Math.abs(height)}px`;
    element.current.style.transform = `scaleY(${height < 0 ? -1 : 1})`;
  }, []);
    ...
    >
      <defs>
        <clipPath id="__lottie_element_176">
          <rect height="267" width="1082" x="0" y="0"></rect>
        </clipPath>
      </defs>
      <g clipPath="url(#__lottie_element_176)">
        <g opacity="1" style={{ display: "block" }} transform="matrix(1,0,0,1,4.1400146484375,133.5)">
          <path
        ...
        <g opacity="1" style={{ display: "block" }} transform="matrix(1,0,0,1,0,50.752960205078125)">
          <path
        ...
        <g opacity="1" style={{ display: "block" }} transform="matrix(1,0,0,1,0,92.03285217285156)">
          <path
